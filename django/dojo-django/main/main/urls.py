...
urlpatterns = [
    ...
    url(r'^randomword/', include('apps.random_word.urls')),
    ...
    url(r'^gold/', include('apps.django_gold.urls')),
    url(r'^users/', include('apps.users.urls')),
    url(r'^dojo/', include('apps.dojo_ninjas.urls')),
    url(r'^book_authors/', include('apps.book_authors.urls')),
    url(r'^likebooks/', include('apps.likeBooks.urls')),
    url(r'^rest/', include('apps.semiRest.urls'))
]
